...
import com.gustavosdaniel.myfinance_api.erro.ErrorDoc;
...
public interface ErrorDocControllerApi {
    ...
    ResponseEntity<Map<String, ErrorDoc>> getAllErrorDocs();
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(schema = @Schema(implementation = ErrorDoc.class))
            ),
            @ApiResponse(
                    responseCode = "404",
    ...
    ResponseEntity<ErrorDoc> getErrorDoc(
