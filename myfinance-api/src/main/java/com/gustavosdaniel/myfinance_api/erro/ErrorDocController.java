...
import com.gustavosdaniel.myfinance_api.openApi.ErrorDocControllerApi;
...
public class ErrorDocController implements ErrorDocControllerApi {
     ...
     * e o valor é o objeto {@link ErrorDoc} com os detalhes de causa e solução.
     */
    @GetMapping
    public ResponseEntity<Map<String, ErrorDoc>> getAllErrorDocs() {
