...
import com.gustavosdaniel.myfinance_api.documentation.ErroDocRegistry;
...
public class ErrorDocController implements ErrorDocControllerApi {
     ...
     * e o valor é o objeto {@link ErroDocResponse} com os detalhes de causa e solução.
     */
    @GetMapping
    public ResponseEntity<Map<String, ErroDocResponse>> getAllErrorDocs() {
     ...
     */
    @GetMapping("/{errorKey}")
    public ResponseEntity<ErroDocResponse> getErrorDoc(@PathVariable String errorKey){
