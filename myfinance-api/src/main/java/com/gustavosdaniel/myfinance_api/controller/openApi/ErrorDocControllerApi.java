...
public interface ErrorDocControllerApi {
    ...
    ResponseEntity<Map<String, ErrorDocResponse>> getAllErrorDocs();
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(schema = @Schema(implementation = ErrorDocResponse.class))
            ),
            @ApiResponse(
                    responseCode = "404",
    ...
    ResponseEntity<ErrorDocResponse> getErrorDoc(
